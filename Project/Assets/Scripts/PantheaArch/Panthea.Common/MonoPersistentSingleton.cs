...
{
    [Preserve]
    public class MonoPersistentSingleton : BetterMonoBehaviour
    {
        [Preserve]
    ...
    [Preserve]
    public abstract class MonoPersistentSingleton<T>: MonoPersistentSingleton where T : MonoPersistentSingleton
    {
        [Preserve]
        ...
        private static void CreateInstance()
        {
            ...
            if (mInst == null && Application.isPlaying)
            {
                ...
                mInst = singletonObject.AddComponent<T>();
                mInst.OnCreate();
                // 使对象在场景切换时不被销毁
