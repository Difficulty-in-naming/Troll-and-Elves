...
namespace ScratchCardAsset
{
	...
	public class ScratchCard : MonoBehaviour
	{
		...
		private void SubscribeToEvents()
		{
			...
			Input.OnScratchStart += InputOnOnScratchStart;
			Input.OnScratchEnd += InputOnOnScratchEnd;
		}

		private void InputOnOnScratchEnd(int obj) => OnScratchEnd?.Invoke(obj);
		private void InputOnOnScratchStart(int obj) => OnScratchStart?.Invoke(obj);
